                  ...
                  children: [
                    ...
                    if (!isSingleOrPractice) ...[
                      ...
                      SelectCategoryWidget2(
                        ...
                        isShowBgColor: false,
                        voteIndicator:
                            selectedMultipleOption == 'Asiiro' ? '1' : null,
                        bgColor: bgColor[isMultipleOption],
                        brColor: brColor[isMultipleOption],
                        onTap: () {
                          setState(() {
                      ...
                      SelectCategoryWidget2(
                        ...
                        isShowBgColor: false,
                        voteIndicator:
                            selectedMultipleOption == 'Asiiroo' ? '1' : null,
                        bgColor: bgColor[isMultipleOption],
                        brColor: brColor[isMultipleOption],
                        onTap: () {
                          setState(() {
                              ...
                              await Future.delayed(3.seconds).then((_) {
                                if (context.mounted) {
                                  showModalBottomSheet(
                                    ...
                                    builder: (context) =>
                                        const PerformanceModal(type: 'success'),
                                  ).then((_) {
                                    setState(() {
                                      isMultiplayerAnswerSelected = false;
                                      selectedMultipleOption = null;
                              ...
                              await Future.delayed(3.seconds).then((_) {
                                if (context.mounted) {
                                  showModalBottomSheet(
                                    ...
                                    barrierColor: AppColors.transparent,
                                    builder: (context) =>
                                        const PerformanceModal(type: 'failure'),
                                  ).then((_) {
                                    setState(() {
                                      isMultiplayerAnswerSelected = false;
                                      selectedMultipleOption = null;
                            ...
                            for (int i = 0; i < wordTile.length; i++)
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        bgColor[isWordTileArrangedCorrectly] ??
                                            AppColors.blueE7,
                                    border: Border.all(
                                      color: brColor[
