...
class PlayersGameAnalyticsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _PlayerGameAnalyticsScreen(gameCode: gameCode),
    );
  }
}

class _PlayerGameAnalyticsScreen extends HookWidget {
  const _PlayerGameAnalyticsScreen({required this.gameCode});
                      ...
                      return Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 8),
                            _AnalyticsWidget(
                              icon: AppAssets.images.svgs.questionAnswer.svg(),
